...
function output_content_data() {
	...
	// エディター画面でのみ出力
	// site-editor.php は WP のサイトエディター／パターン編集画面（WP5.9以降）。これがないと
	// パターン編集中にふきだしブロック等の window データが取れずクラッシュする。
	global $hook_suffix;
	$has_editor = 'post.php' === $hook_suffix
		|| 'post-new.php' === $hook_suffix
		|| 'widgets.php' === $hook_suffix
		|| 'customize.php' === $hook_suffix
